...
const DEMO_RESULTS = {
  ...
  products: [
    { name: "MacBook Pro 14\" M3", price: "2 199 €", source: "apple.com", category: "Ordinateurs", stock: "En stock", rating: "4.8/5" },
    { name: "Dell XPS 15", price: "1 799 €", source: "dell.com", category: "Ordinateurs", stock: "En stock", rating: "4.6/5" },
    { name: "Sony WH-1000XM5", price: "349 €", source: "sony.fr", category: "Audio", stock: "En stock", rating: "4.9/5" },
    { name: "iPhone 16 Pro", price: "1 229 €", source: "apple.com", category: "Smartphones", stock: "En stock", rating: "4.7/5" },
    { name: "Samsung Galaxy S25", price: "1 099 €", source: "samsung.com", category: "Smartphones", stock: "Limité", rating: "4.5/5" },
  ],
  sites: [
  ...
  const handleAI = async () => {
    ...
    const response = await fetch("/api/claude", {
      ...
      body: JSON.stringify({
        ...
        messages: [{
          role: "user",
          content: `Tu es un assistant expert en scraping web et en collecte de données pour freelances.
Un client freelance te pose cette question : "${aiPrompt}"

Réponds en français, de façon concise et pratique. Si c'est une demande de stratégie de scraping, donne :
- Les meilleures sources à scraper
- Les champs de données à extraire
- Des tips professionnels
- Une estimation de volume de données
...
Reste concis (max 200 mots).`
  ...
  const stats = [
    { label: "Scrapes effectués", value: "1 247", icon: "⚡" },
    { label: "Données exportées", value: "48 932", icon: "📊" },
    { label: "Clients actifs", value: "12", icon: "👥" },
    { label: "Taux de succès", value: "98.4%", icon: "✅" },
  ];
      ...
      <div style={{ display: "flex", minHeight: "100vh" }}>
        ...
        <div style={{
          ...
          <div style={{ padding: "16px 20px", borderTop: "1px solid #1a2035", fontSize: 12, color: "#2d3748" }}>
            ...
            <div style={{ color: "#4a5568", marginTop: 4 }}>120 / 500 utilisés</div>
          </div>
        </div>
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ fontSize: 12, color: "#4a5568", marginTop: 2, fontFamily: "Space Mono" }}>
                Samedi 18 avril 2026 · API connectée
              </div>
            </div>
              ...
              <div style={{ maxWidth: 860, margin: "0 auto" }}>
                ...
                <div className="card" style={{
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 16 }}>
                    <div>
                      ...
                      <input
                        ...
                        placeholder="ex: agences SEO Paris, restaurants Lyon…"
                        style={{
                  ...
                  <div style={{ marginBottom: 20 }}>
                    <label style={{ display: "block", fontSize: 12, color: "#4a5568", marginBottom: 8, fontFamily: "Space Mono" }}>
                      Nombre max d'éléments : <span style={{ color: "#7b61ff" }}>{maxItems}</span>
                    </label>
                    <input
                  ...
                  <div className="card" style={{
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
                      <div style={{ fontSize: 13, fontWeight: 700, color: "#00e5ff", letterSpacing: "0.08em", textTransform: "uppercase" }}>
                        Résultats — {results.length} entrées
                      </div>
              ...
              <div style={{ maxWidth: 700, margin: "0 auto" }}>
                <div className="card" style={{
                  ...
                  <div style={{ fontSize: 13, color: "#4a5568", marginBottom: 20 }}>
                    Posez vos questions sur la stratégie de scraping, les sources à utiliser, les données à extraire…
                  </div>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                    <textarea
                      ...
                      placeholder="ex: Mon client veut une liste de 200 restaurants bio à Paris avec leurs emails. Quelle est la meilleure stratégie ?"
                      rows={4}
                      style={{
                    ...
                    <button onClick={handleAI} disabled={aiLoading || !aiPrompt} style={{
                      ...
                      {aiLoading ? <Spinner /> : "🤖 Demander à l'IA"}
                    </button>
                  </div>
                  ...
                  {aiResult && (
                    <div style={{
                      ...
                      <div style={{ fontSize: 11, color: "#7b61ff", fontFamily: "Space Mono", marginBottom: 10 }}>RÉPONSE IA</div>
                      {aiResult}
                    </div>
                  )}
                  ...
                  <div style={{ marginTop: 20, display: "flex", flexWrap: "wrap", gap: 8 }}>
                    {[
                      ...
                      "Scraper LinkedIn légalement",
                      "Données e-commerce à extraire",
                      "Prix et délais estimés client"
                    ].map(s => (
              ...
              <div style={{ maxWidth: 600, margin: "0 auto" }}>
                <div className="card" style={{
                  ...
                  {[
                    ...
                    { label: "Délai entre requêtes (ms)", placeholder: "1500", type: "number" },
                  ].map((f, i) => (
